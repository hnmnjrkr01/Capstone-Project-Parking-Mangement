...
<div class="form-container">
    <h2>Self Data Edit</h2>
    <form action="/User/selfEditSubmit" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" id = "username" name="username" placeholder="User Name" value="${userEditDTO.username}">
